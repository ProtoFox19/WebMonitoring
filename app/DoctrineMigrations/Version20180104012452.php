 ...
 */
class Version20180104012452 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE sitemap_settings CHANGE not_included_path not_included_path LONGTEXT DEFAULT NULL, CHANGE notably_path notably_path LONGTEXT DEFAULT NULL');
    }
