 ...
 */
class Version20180104071032 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE sitemap_settings CHANGE not_included_path not_included_path MEDIUMTEXT NOT NULL COLLATE utf8_unicode_ci, CHANGE notably_path notably_path MEDIUMTEXT NOT NULL COLLATE utf8_unicode_ci');
    }
}
